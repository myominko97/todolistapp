...
filters = document.querySelectorAll(".controls-bar span"),
...
function showTodo(filter){
    ...
    todos.forEach((todo, id) =>{
        ...
        if(filter == todo.status || filter == "all"){
            ...
            <div class="editings">
                <i onclick="showMenu(this)" class="material-symbols-outlined">
                    more_horiz
                    </i>
                <ul class="task-menu">
                    <li onclick="editTask(${id}, ' ${todo.name}')"><i class="material-symbols-outlined">
                        edit
                        </i>Edit</li>
                    <li onclick="deleteTask(${id})"><i class="material-symbols-outlined">
                        delete
                        </i>Delete</li>
                </ul>
            </div>
...
function updateStatus(selectedTask){
    ...
    if(selectedTask.checked){
        ...
        //updating the status of selectd task to completed
        todos[selectedTask.id].status = "completed";
    }else{
        taskName.classList.remove("checked");
        //updating the status of selectd task to pending
